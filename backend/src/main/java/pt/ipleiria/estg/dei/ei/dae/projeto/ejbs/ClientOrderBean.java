...
public class ClientOrderBean {
    ...
    public void create(String finalCostumerUsername, List<ProductOrderDTO> products) throws MyEntityNotFoundException, NoStockException {
        ...
        try {
            ...
            entityManager.flush();
            clientOrder.setStatus(OrderStatus.STATUS_0);
    ...
    public void changeLogistic(long code, String logisticOperatorCode) throws MyEntityNotFoundException {
    ...
    public void changeStatus(long code, String status) throws MyEntityNotFoundException {
        ...
        if (orderStatus == OrderStatus.STATUS_3)
            clientOrder.setDeliveredAt(new Date());
    }
