...
<template>
  <VForm @submit.prevent="save">
    <VRow>
      <VCol cols="12">
        <VTextField
          v-model="productCatalogForm.name"
      ...
      <VCol cols="12">
        <VTextField
          v-model="productCatalogForm.catalogArea"
          label="Área do Catálogo"
          placeholder="Tecnologia"
        />
      </VCol>
      <VCol cols="12">
        <VTextField
          v-model="productCatalogForm.category"
          label="Categoria do Catálogo"
          placeholder="Telemóveis"
        />
      </VCol>
      <VCol cols="12">
        <VTextField
          v-model="productCatalogForm.description"
          label="Descrição"
        />
      </VCol>
      <VCol cols="12">
      ...
      <VCol cols="6">
        <div
          class="package-item"
          :class="{ 'package-item-disabled': isSecondaryPackageActive }"
        >
          <VCheckbox
            :model-value="true"
            readonly
          ...
          />
          <VTextField
            v-model="productCatalogForm.primaryPackageVolume"
            type="number"
            class="product-quantity"
            style="width: 300px;"
            label="Volume"
          />
          <VTextField
            v-model="productCatalogForm.primaryPackageMaterial"
            label="Material"
            class="product-quantity"
            style="width: 100%;"
          />
      ...
      <VCol cols="6">
        ...
        >
          <VCheckbox
            v-model="isSecondaryPackageActive"
            @input="resetPackageNumber(true)"
          />
          <VTextField
            v-model="productCatalogForm.maxSecondaryPackage"
            type="number"
            :disabled="!isSecondaryPackageActive"
            class="product-quantity"
            label="Quantidade"
          />
          <VTextField
            v-model="productCatalogForm.secondaryPackageMaterial"
            :disabled="!isSecondaryPackageActive"
            label="Material"
            class="product-quantity"
            style="width: 100%;"
      ...
      <VCol cols="6">
        <div
          class="package-item"
          :class="{ 'package-item-disabled': isTertiaryPackageActive }"
        >
          <VCheckbox
            v-model="isTertiaryPackageActive"
            @input="resetPackageNumber(false)"
          />
          <VTextField
            v-model="productCatalogForm.maxTertiaryPackage"
            type="number"
            :disabled="!isTertiaryPackageActive"
            class="product-quantity"
            label="Quantidade"
          />
          <VTextField
            v-model="productCatalogForm.tertiaryPackageMaterial"
            :disabled="!isTertiaryPackageActive"
            label="Material"
            class="product-quantity"
            style="width: 100%;"
